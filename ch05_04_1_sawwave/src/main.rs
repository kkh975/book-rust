...
fn main() {
    ...
    wav.extend(sawtooth_wave(60, calc_len(bpm, 4), 0.5)); // 60 -> 도
    wav.extend(sawtooth_wave(64, calc_len(bpm, 4), 0.5)); // 64 -> 미
    wav.extend(sawtooth_wave(67, calc_len(bpm, 4), 0.5)); // 67 -> 솔
